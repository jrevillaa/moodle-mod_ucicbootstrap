...
function xmldb_ucicbootstrap_upgrade($oldversion) {
    global $CFG, $DB;
    ...
    if ($oldversion < 2015010600) {
        ...
        // Define field bootstrapstyle to be added to ucicbootstrap.
        $table = new xmldb_table('ucicbootstrap');
        ...
        upgrade_mod_savepoint(true, 2015010600, 'ucicbootstrap');
    }
    return true;
}
