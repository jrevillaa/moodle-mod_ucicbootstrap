        ...
        switch($ucicbootstrap->bootstraptype) {
            case 0:
                $info->content = ucicbootstrap_modal_outline($ucicbootstrap->name, $ucicbootstrap->title,
                        ...
                        ucicbootstrap_modal_button($ucicbootstrap->name, $ucicbootstrap->title, $ucicbootstrap->bootstrapicon);
            break;
...
function ucicbootstrap_modal_button($modalname, $modaltitle, $icon) {
...
function ucicbootstrap_blockquote($name, $title, $content, $icon) {
    ...
    $output .= html_writer::end_tag('blockquote');
    return $output;
>>>>>>> ca093e3f4c599521eda058315ac6a18bbf7f772f
}