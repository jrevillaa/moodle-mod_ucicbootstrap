...
require_once($CFG->dirroot . '/mod/ucicbootstrap/backup/moodle2/backup_ucicbootstrap_stepslib.php');

/**
 * Provides the steps to perform one complete backup of the Bootstrap instance
 */
class backup_ucicbootstrap_activity_task extends backup_activity_task {
    ...
    protected function define_my_steps() {
        $this->add_step(new backup_ucicbootstrap_activity_structure_step('ucicbootstrap_structure'
                , 'ucicbootstrap.xml'));
    }
